...
(function () {
  ...
  function scanPage() {
    ...
    // 4g. Footer-specialized pass. Many sites bury their canonical
    // contact info in the footer with labeled fields ("Email:",
    // "Toll Free:", "Sales:", "Fax:") that the generic body-text scan
    // catches but doesn't credit specially.
    scanFooterSpecialized(results, seen);

    // 4h. Site-specific override library. Curated registry of known
    // support contacts for painful-to-scrape sites. Surfaces canonical
    // contact directly; on-page finds still run and win on ties via
    // canonical phoneKey dedup.
