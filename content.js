...
(function () {
  ...
  function scanPage() {
    ...
    // 4e. Press-release / media-contact extraction. Press releases follow
    // a standard convention: a "Media Contact:" or "For more information:"
    // block near the bottom with the PR person's email and phone. Surface
    // those specifically so a user reading a press release can reach the
    // person behind it.
